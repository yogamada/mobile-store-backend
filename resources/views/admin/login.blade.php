...
<head>
    ...
    <title>Masuk — MoboAdmin</title>
    <meta name="description" content="Login panel administrator MobileStore">
...
<body>
    ...
    <div class="right-panel">
        <div class="form-box">
            ...
            <h2 class="form-title">Halo,<br>Selamat Datang!</h2>
            <p class="form-sub">Masuk untuk mengelola toko dan konsumen kamu.</p>
            ...
            <div style="text-align: center; margin-top: 20px;">
                <p style="font-size: 13.5px; color: var(--gray); font-weight: 500;">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" style="color: var(--terra); font-weight: 700; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='var(--terra-dark)'" onmouseout="this.style.color='var(--terra)'">Daftar sekarang</a>
                </p>
            </div>
            ...
            <div class="form-note">
                ...
                <p>Akses terbatas hanya untuk administrator terdaftar. Hubungi IT support jika mengalami kendala.</p>
            </div>
